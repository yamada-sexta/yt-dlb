...
import type { PoTokenProvider, PoTokenProviderConstructor, PoTokenPreference } from "./provider.ts";
...
export function providerDisplayList(providers: Iterable<PoTokenProvider>): string {
