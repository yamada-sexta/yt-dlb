...
export class ZattooLiveIE extends ZattooBaseIE { static override readonly _VALID_URL = createValidUrl(ZattooBaseIE.HOST, String.raw`[^/?&#]+`, "channel", "live"); static override readonly TYPE = "live" as const; static override suitable(url: string): boolean { return ZattooIE.suitable(url) ? false : ZattooBaseIE.suitable(url); } }
...
export class NetPlusTVLiveIE extends NetPlusTVBaseIE { static override readonly _VALID_URL = createValidUrl(NetPlusTVBaseIE.HOST, String.raw`[^/?&#]+`, "channel", "live"); static override readonly TYPE = "live" as const; static override suitable(url: string): boolean { return NetPlusTVIE.suitable(url) ? false : NetPlusTVBaseIE.suitable(url); } }
...
export class MNetTVLiveIE extends MNetTVBaseIE { static override readonly _VALID_URL = createValidUrl(MNetTVBaseIE.HOST, String.raw`[^/?&#]+`, "channel", "live"); static override readonly TYPE = "live" as const; static override suitable(url: string): boolean { return MNetTVIE.suitable(url) ? false : MNetTVBaseIE.suitable(url); } }
...
export class WalyTVLiveIE extends WalyTVBaseIE { static override readonly _VALID_URL = createValidUrl(WalyTVBaseIE.HOST, String.raw`[^/?&#]+`, "channel", "live"); static override readonly TYPE = "live" as const; static override suitable(url: string): boolean { return WalyTVIE.suitable(url) ? false : WalyTVBaseIE.suitable(url); } }
...
export class BBVTVLiveIE extends BBVTVBaseIE { static override readonly _VALID_URL = createValidUrl(BBVTVBaseIE.HOST, String.raw`[^/?&#]+`, "channel", "live"); static override readonly TYPE = "live" as const; static override suitable(url: string): boolean { return BBVTVIE.suitable(url) ? false : BBVTVBaseIE.suitable(url); } }
...
export class VTXTVLiveIE extends VTXTVBaseIE { static override readonly _VALID_URL = createValidUrl(VTXTVBaseIE.HOST, String.raw`[^/?&#]+`, "channel", "live"); static override readonly TYPE = "live" as const; static override suitable(url: string): boolean { return VTXTVIE.suitable(url) ? false : VTXTVBaseIE.suitable(url); } }
...
export class GlattvisionTVLiveIE extends GlattvisionTVBaseIE { static override readonly _VALID_URL = createValidUrl(GlattvisionTVBaseIE.HOST, String.raw`[^/?&#]+`, "channel", "live"); static override readonly TYPE = "live" as const; static override suitable(url: string): boolean { return GlattvisionTVIE.suitable(url) ? false : GlattvisionTVBaseIE.suitable(url); } }
...
export class SAKTVLiveIE extends SAKTVBaseIE { static override readonly _VALID_URL = createValidUrl(SAKTVBaseIE.HOST, String.raw`[^/?&#]+`, "channel", "live"); static override readonly TYPE = "live" as const; static override suitable(url: string): boolean { return SAKTVIE.suitable(url) ? false : SAKTVBaseIE.suitable(url); } }
...
export class EWETVLiveIE extends EWETVBaseIE { static override readonly _VALID_URL = createValidUrl(EWETVBaseIE.HOST, String.raw`[^/?&#]+`, "channel", "live"); static override readonly TYPE = "live" as const; static override suitable(url: string): boolean { return EWETVIE.suitable(url) ? false : EWETVBaseIE.suitable(url); } }
...
export class QuantumTVLiveIE extends QuantumTVBaseIE { static override readonly _VALID_URL = createValidUrl(QuantumTVBaseIE.HOST, String.raw`[^/?&#]+`, "channel", "live"); static override readonly TYPE = "live" as const; static override suitable(url: string): boolean { return QuantumTVIE.suitable(url) ? false : QuantumTVBaseIE.suitable(url); } }
...
export class OsnatelTVLiveIE extends OsnatelTVBaseIE { static override readonly _VALID_URL = createValidUrl(OsnatelTVBaseIE.HOST, String.raw`[^/?&#]+`, "channel", "live"); static override readonly TYPE = "live" as const; static override suitable(url: string): boolean { return OsnatelTVIE.suitable(url) ? false : OsnatelTVBaseIE.suitable(url); } }
...
export class EinsUndEinsTVLiveIE extends EinsUndEinsTVBaseIE { static override readonly _VALID_URL = createValidUrl(EinsUndEinsTVBaseIE.HOST, String.raw`[^/?&#]+`, "channel", "live"); static override readonly TYPE = "live" as const; static override suitable(url: string): boolean { return EinsUndEinsTVIE.suitable(url) ? false : EinsUndEinsTVBaseIE.suitable(url); } }
...
export class SaltTVLiveIE extends SaltTVBaseIE { static override readonly _VALID_URL = createValidUrl(SaltTVBaseIE.HOST, String.raw`[^/?&#]+`, "channel", "live"); static override readonly TYPE = "live" as const; static override suitable(url: string): boolean { return SaltTVIE.suitable(url) ? false : SaltTVBaseIE.suitable(url); } }
